...
1. [Antes de começar: o que é o Apptainer?](#1-antes-de-começar-o-que-é-o-apptainer)
2. [Os conceitos fundamentais](#2-os-conceitos-fundamentais)
3. [Instalação e primeiros testes](#3-instalação-e-primeiros-testes)
4. [Cache e espaço em disco](#4-cache-e-espaço-em-disco)
...
11. [Exemplos práticos em bioinformática](#11-exemplos-práticos-em-bioinformática)
12. [Como organizar um projeto](#12-como-organizar-um-projeto)
13. [Reprodutibilidade e boas práticas](#13-reprodutibilidade-e-boas-práticas)
